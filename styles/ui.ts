export const ds = {
  colors: {
    ...
    cardShadow: "shadow-xl shadow-blue-900/30"
  },
  spacing: {
    s: "p-2",
    m: "p-4",
  ...
  typography: {
    heading: "text-lg font-semibold tracking-tight text-slate-100",
    subheading: "text-sm text-slate-400",
    body: "text-sm text-slate-300 leading-relaxed",
    kpiLabel: "text-xs font-semibold uppercase tracking-wide text-slate-400",
  ...
  table: {
    header: "bg-slate-900/80 text-xs font-semibold uppercase tracking-wide text-slate-400",
    row: "odd:bg-slate-900/50 even:bg-slate-900/30",
